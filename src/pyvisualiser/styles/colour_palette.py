...
COLOUR_THEMES= {    'white' : {'light':[255,255,175], 'mid':[200,200,125], 'dark':grey, 'foreground':white, 'background':[50, 50, 50], 'alert':red,'range':[[255,255,75], [255,255,175], white] },
                    ...
                    'hifi0'  : { 'background': [5, 15, 30], 'dark': [25, 40, 60], 'mid': [50, 65, 85], 'light': [180, 230, 255],  'foreground': [230, 240, 255], 'alert': [0, 191, 255],   'range': [[30, 45, 65],    [40, 80, 160],    [0, 120, 200],   [0, 191, 255],   [240, 255, 255]  ] },
                    'hifi'  : { 'background': [0, 15, 30], 'dark': [30, 45, 65],  'mid': [40, 80, 160], 'light': [0, 190, 240],  'foreground': [230, 240, 255], 'alert': [0, 191, 255],   'range': [[30, 45, 65],    [40, 80, 160],    [0, 120, 200],   [0, 191, 255],   [240, 255, 255]  ] }
                }
