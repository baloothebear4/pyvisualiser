...
SCREENS = ( SpectrumBaseArt, MinSpectrumArt, ArtistScreen, StereoSpectrumSplitScreen, TrackScreen, MetaVUScreen, TrackSpectrumScreen, TrackSpectrumScreen2, TrackSpectrumScreen3, TrackSpectrumScreen4, \
