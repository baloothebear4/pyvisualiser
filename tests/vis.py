...
HERO_SCREENS  = (H1,H2,H3,H4,H5,H6,H7,H8,H9)

SCREENS =  HERO_SCREENS +  GLSCREENS +TEST_SCREENS2# +VU_METER_SCREENS# + MANY_SCREENS#+ ART_SCREENS +SPECTRUM_TEST_SCREENS+(SamplesFrame,Screen7, VUTestScreen1,  VUTestScreen2,VUImageScreen)#+FULL_SCREENS#+GEO_TEST_SCREENS
