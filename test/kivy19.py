# kivy_landscape_rotated_fixed.py
...
class RotatedRoot(Widget):
    """Rotate entire UI 90° clockwise and shift into view."""
    ...
    def _update_transform(self, *args):
        ...
        with self.canvas.before:
            PushMatrix()
            # Move origin to the right, since after rotation X/Y swap
            Translate(self.width, 0)
            Rotate(origin=(0, 0), angle=90)  # rotate clockwise
