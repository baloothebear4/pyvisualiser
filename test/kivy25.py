...
class RotatedRoot(Widget):
    ...
    def _rotate_point(self, x, y):
        """Map portrait touch to landscape correctly."""
        w, h = self.width, self.height
        # This mapping was the one where buttons worked correctly:
        return h - y, x
...
class TestLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # Explicitly force horizontal slider
        self.slider = Slider(min=0, max=100, value=50, orientation='horizontal')
